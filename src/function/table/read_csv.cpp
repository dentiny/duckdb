...
void ReadCSVTableFunction::ReadCSVAddNamedParameters(TableFunction &table_function) {
	...
	table_function.named_parameters["header"] = NamedParameterType::Castable(LogicalType::BOOLEAN);
	table_function.named_parameters["auto_detect"] = NamedParameterType::Castable(LogicalType::BOOLEAN);
	table_function.named_parameters["sample_size"] = NamedParameterType::Castable(LogicalType::BIGINT);
	table_function.named_parameters["all_varchar"] = NamedParameterType::Castable(LogicalType::BOOLEAN);
	table_function.named_parameters["dateformat"] = LogicalType::VARCHAR;
	table_function.named_parameters["timestampformat"] = LogicalType::VARCHAR;
	table_function.named_parameters["normalize_names"] = NamedParameterType::Castable(LogicalType::BOOLEAN);
	table_function.named_parameters["compression"] = LogicalType::VARCHAR;
	table_function.named_parameters["skip"] = NamedParameterType::Castable(LogicalType::BIGINT);
	table_function.named_parameters["max_line_size"] = NamedParameterType::Castable(LogicalType::VARCHAR);
	table_function.named_parameters["maximum_line_size"] = NamedParameterType::Castable(LogicalType::VARCHAR);
	table_function.named_parameters["ignore_errors"] = NamedParameterType::Castable(LogicalType::BOOLEAN);
	table_function.named_parameters["store_rejects"] = NamedParameterType::Castable(LogicalType::BOOLEAN);
	...
	table_function.named_parameters["rejects_limit"] = NamedParameterType::Castable(LogicalType::BIGINT);
	table_function.named_parameters["rejects_line_size_limit"] = NamedParameterType::Castable(LogicalType::BIGINT);
	table_function.named_parameters["force_not_null"] = LogicalType::LIST(LogicalType::VARCHAR);
	table_function.named_parameters["buffer_size"] = NamedParameterType::Castable(LogicalType::UBIGINT);
	table_function.named_parameters["decimal_separator"] = LogicalType::VARCHAR;
	table_function.named_parameters["parallel"] = LogicalType::BOOLEAN;
	table_function.named_parameters["null_padding"] = NamedParameterType::Castable(LogicalType::BOOLEAN);
	...
	table_function.named_parameters["files_to_sniff"] = NamedParameterType::Castable(LogicalType::BIGINT);
