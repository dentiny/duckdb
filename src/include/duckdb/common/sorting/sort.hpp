...
public:
	...
	SinkResultType Sink(ExecutionContext &context, DataChunk &chunk, OperatorSinkInput &input) const DUCKDB_NO_THREAD_SAFETY_ANALYSIS;
	SinkCombineResultType Combine(ExecutionContext &context, OperatorSinkCombineInput &input) const DUCKDB_NO_THREAD_SAFETY_ANALYSIS;
...
public:
	...
	//===--------------------------------------------------------------------===//
	SourceResultType MaterializeColumnData(ExecutionContext &context, OperatorSourceInput &input) const DUCKDB_NO_THREAD_SAFETY_ANALYSIS;
