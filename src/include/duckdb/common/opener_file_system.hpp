...
public:
	...
	void RegisterCompressionFilesystem(FileCompressionType compression_type, unique_ptr<FileSystem> fs) override {
		GetFileSystem().RegisterCompressionFilesystem(std::move(compression_type), std::move(fs));
	}
